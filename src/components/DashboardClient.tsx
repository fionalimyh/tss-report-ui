...
function getDefaultFilters(now: Date): GlobalFilters {
...
export function DashboardClient({ initialNowIso }: Props) {
  ...
  return (
    <div className="min-h-screen">
      ...
      <GlobalFilterPanel
        key={globalFilterPanelKey}
        filters={appliedFilters}
        countryOptions={countryOptions}
        monthAnchorIso={initialNowIso}
